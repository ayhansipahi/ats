...
import {
  FETCH_VEHICLEDEVICE,
  SAVE_VEHICLEDEVICE,
  CREATE_VEHICLEDEVICE,
  DELETE_VEHICLEDEVICE
} from "../../store/modules/vehicleDevice";
...
export default {
  ...
  methods: {
    ...mapActions({
      fetchItems: FETCH_VEHICLEDEVICE,
      setBreadCrumb: SET_BREADCRUMB,
      saveItem: SAVE_VEHICLEDEVICE,
      createItem: CREATE_VEHICLEDEVICE,
      deleteItem: DELETE_VEHICLEDEVICE
    }),
    fetchOptions() {
