<template>
  <div>
    ...
    <!--      <div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">-->
    <!--        &lt;!&ndash;begin:: Widgets/Inbound Bandwidth&ndash;&gt;-->
    <!--        <KTPortlet-->
    <!--          v-bind="{-->
    ...
    <!--          </template>-->
    <!--        </KTPortlet>-->
    <!--        &lt;!&ndash;end:: Widgets/Inbound Bandwidth&ndash;&gt;-->
    <!--        <div class="kt-space-20"></div>-->
    <!--        &lt;!&ndash;begin:: Widgets/Outbound Bandwidth&ndash;&gt;-->
    <!--        <KTPortlet-->
    <!--          v-bind="{-->
    ...
    <!--          </template>-->
    <!--        </KTPortlet>-->
    <!--        &lt;!&ndash;end:: Widgets/Outbound Bandwidth&ndash;&gt;-->
    <!--      </div>-->

    <!--      <div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">-->
    <!--        &lt;!&ndash;Begin::Recent Activities&ndash;&gt;-->
    ...
    <!--          </template>-->
    <!--        </KTPortlet>-->
    <!--        &lt;!&ndash;End::Recent Activities&ndash;&gt;-->
    <!--      </div>-->
    <!--    </div>-->
